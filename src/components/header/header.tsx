            ...
            <div class="text-white ">
              <div class="row">
                <div class="col-12 ">
                  ...
                  <ul class="flex flex-row my-8">
                    ...
                    <li class="px-4 hover:text-blue-500">
                      <a href="/blog" target="_self" class="font-sans text-lg">
                        Blog
                      </a>
                    </li>
              ...
              <div className="row">
                <div className="col-12">
                  <ul class="flex flex-row my-8 work">
                    <li class="pr-4 hover:text-blue-500">
                      <a href="/services" class="text-2xl font-sans">Services</a>
                    </li>
                    <li class="px-4 hover:text-blue-500">
                      <a href="/our-work" class="text-2xl font-sans">Our Work</a>
                    </li>
                  </ul>
                </div>
>>>>>>> Stashed changes
